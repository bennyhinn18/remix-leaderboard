...
export default function ResourcesPage() {
  ...
  const fullText = 'Basher Resource Terminal';
          ...
          {domains.map((domain, index) => (
            ...
            >
              <div className="p-6 relative">
                <div className="absolute top-3 right-3 text-xs text-[#00ff9d]/50">
                  ID: {domain.id}
                </div>
                ...
                <p className="text-[#00ff9d]/80 text-sm ml-4 border-l-2 border-[#00ff9d]/30 pl-2">
                  {domain.focus}
                </p>
              </div>
