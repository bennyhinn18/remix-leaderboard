...
import { 
  Crown, ChevronLeft, Trophy, Star, ArrowRight, 
  Sparkles, Github, User, Code, Globe
} from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-yellow-200/80 max-w-2xl mx-auto">
            Legacy Bashers represent our most dedicated and accomplished members. Their exceptional 
            contributions and commitment have earned them legendary status within our community.
          </p>
        </motion.div>
          ...
          {legacyBashers.length > 0 ? (
            legacyBashers.map((basher, index) => (
              <motion.div
                ...
                className="group"
              >
                <Link to={`/profile/${basher.github_username}`} className="block">
                  <div className="relative bg-gradient-to-br from-yellow-900/40 to-amber-900/40 backdrop-blur-md rounded-2xl overflow-hidden border border-yellow-500/30 shadow-lg shadow-amber-500/20">
                    ...
                    <div className="p-6">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-white">{basher.name}</h3>
                          <div className="flex items-center gap-1 text-yellow-300">
                            <Github className="w-4 h-4" />
                            <span className="text-sm">@{basher.github_username}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-4">
                        <div className="bg-black/20 rounded-lg p-2 text-center">
                          ...
                          <div className="text-xl font-bold text-amber-300">{basher.bash_points}</div>
                          <div className="text-xs text-amber-200/70">Points</div>
                        </div>
                        ...
                        <div className="bg-black/20 rounded-lg p-2 text-center">
                          ...
                          <div className="text-xl font-bold text-amber-300">{basher.stats?.projects || 0}</div>
                          <div className="text-xs text-amber-200/70">Projects</div>
                        </div>
                        ...
                        <div className="bg-black/20 rounded-lg p-2 text-center">
                          ...
                          <div className="text-xl font-bold text-amber-300">{basher.weekly_bash_attendance || 0}%</div>
                          <div className="text-xs text-amber-200/70">Attendance</div>
                        </div>
                      </div>
            ...
            <div className="col-span-3 text-center py-20">
              ...
              <h3 className="text-2xl font-bold text-yellow-500/70">No Legacy Bashers Yet</h3>
