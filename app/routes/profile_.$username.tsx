            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {profile.domains.map((domain) => (
                  <div key={domain} className="bg-blue-500/20 text-blue-300 px-3 py-1.5 rounded-lg text-sm">
                    {domain}
                  </div>
                ))}
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-purple-500/20 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-purple-400">{profile.streaks.github}</div>
                  <div className="text-sm text-purple-400">days on GitHub</div>
                </div>
                <div className="bg-orange-500/20 rounded-lg p-4">
                  <Code className="w-5 h-5 text-orange-400 mb-2" />
                  <div className="text-2xl font-bold text-orange-400">{profile.streaks.leetcode}</div>
                  <div className="text-sm text-orange-400">days on LeetCode</div>
                </div>
                <div className="bg-green-500/20 rounded-lg p-4">
                  <Globe2 className="w-5 h-5 text-green-400 mb-2" />
                  <div className="text-2xl font-bold text-green-400">{profile.streaks.duolingo}</div>
                ...
                <div className="bg-indigo-500/20 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-indigo-400">{profile.streaks.discord}</div>
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {profile.hobbies.map((hobby) => (
                  <span key={hobby} className="bg-blue-500/20 text-blue-300 px-3 py-1.5 rounded-full text-sm">
                    {hobby}
                  </span>
                ))}
              </div>
