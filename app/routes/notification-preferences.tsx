...
import { Bell, MessageSquare, Settings, ChevronLeft, CheckCircle, AlertCircle, Loader2 } from "lucide-react";
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    const preferences = {
      ...
      announcement_notifications: formData.get("announcement_notifications") === "on",
...
export default function NotificationPreferences() {
  const { member, notifications, unreadCount, preferences } = useLoaderData<typeof loader>();
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch 
                    ...
                    onCheckedChange={(checked: boolean) => 
                      setFormState(prev => ({ ...prev, push_enabled: checked }))
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch 
                    ...
                    onCheckedChange={(checked: boolean) => 
                      setFormState(prev => ({ ...prev, in_app_enabled: checked }))
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch 
                    ...
                    onCheckedChange={(checked: boolean) => 
                      setFormState(prev => ({ ...prev, announcement_notifications: checked }))
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch 
                    ...
                    onCheckedChange={(checked: boolean) => 
                      setFormState(prev => ({ ...prev, event_notifications: checked }))
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch 
                    ...
                    onCheckedChange={(checked: boolean) => 
                      setFormState(prev => ({ ...prev, points_notifications: checked }))
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch 
                    ...
                    onCheckedChange={(checked: boolean) => 
                      setFormState(prev => ({ ...prev, system_notifications: checked }))
                    }
                  />
                </div>
              </div>
