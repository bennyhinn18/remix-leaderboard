...
export default function RookieBashers() {
  ...
  const [showCongratsBanner, setShowCongratsBanner] = useState(
    !isPersonalizedView
  );
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-center text-gray-200 max-w-3xl mx-auto">
                    You've been officially selected to become a Basher! Your
                    hard work, dedication, and positive attitude have impressed
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <h2 className="text-2xl font-bold">
                      Congratulations, Bashers of the 2024–28 Batch!
                    </h2>
                  </div>

                  <div className="text-center text-gray-200 max-w-3xl mx-auto space-y-4">
                    <p>
                      So excited to welcome you officially into the Byte Bash
                      Blitz community! Your consistent effort and eagerness in
                      completing all assigned tasks truly reflect your drive to
                      grow, and this achievement is something to be proud of.
                    </p>
                    <p>
                      But remember, this is just the beginning of your journey.
                      Becoming a Basher isn't the final goal, it's the starting
                      point. From here, your contributions and involvement
                      should only grow stronger. We encourage you to engage
                      actively in community initiatives, interact with senior
                      Bashers and make the most of this space we proudly call
                      our second home.
                    </p>
                    <p>
                      This is a place where your curiosity, willingness to learn
                      and spirit of collaboration will shape your growth. Don't
                      hesitate to ask questions, explore new ideas, and push
                      your limits.
                    </p>
                    <p>
                      Also, a gentle reminder, continued involvement is key. A
                      drop in participation may lead to your spot being offered
                      to someone from the "Rising Bash" list, who are equally
                      eager to contribute. So stay consistent, stay curious and
                      keep progressing! Once again, congratulations and welcome
                      aboard, Bashers!
                    </p>
                  ...
                  <div className="mt-6 text-center">
                    ...
                    >
                      <Badge className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-4 py-1.5 text-base border-none">
                        <Check className="w-4 h-4 mr-2" /> Welcome to BYTE BASH
                        BLITZ!
                      </Badge>
                    </motion.div>
                  </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Check out our Rising Bash members who've shown great potential
                  and might become full Bashers in the future!
                </p>
              </div>
              <Link
                to="/rising-bash"
                        ...
                        <div
                          className={`w-10 h-10 rounded-full flex items-center justify-center ${
                            isSelected
                              ...
                              : `${
                                  teamColors[
                                    member.team as keyof typeof teamColors
                                  ].bg
                                } ${
                                  teamColors[
                                    member.team as keyof typeof teamColors
          ...
          !activeTeamFilter ? (
            <>
              <h2 className="text-2xl font-bold mb-4">
                Your Basher Journey Begins Now!
              </h2>
              <p className="text-gray-300 max-w-2xl mx-auto">
                {selectedMember.name}, we're thrilled to have you join the
                Basher community! Your skills, dedication, and enthusiasm make
                you a perfect addition to our team. We can't wait to see all the
                amazing contributions you'll make!
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                These exceptional individuals have demonstrated their skills,
                determination, and community spirit. We're excited to see their
                contributions as full-fledged Bashers. The journey is just
                beginning!
              </p>
            </>
          )}
