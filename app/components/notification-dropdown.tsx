...
import { Bell, X, Check, ChevronRight, CheckCheck, Info, AlertCircle, Calendar, Trophy, Settings } from "lucide-react";
...
export function NotificationDropdown({ memberId, notifications, unreadCount }: NotificationDropdownProps) {
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          <h4 className="font-medium text-sm truncate">{item.notification.title}</h4>
                          <Badge
                            variant="outline"
                            className={`text-[10px] py-0 h-4 ${getBadgeStyles(item.notification.priority)}`}
                          >
                        ...
                        <div className="flex justify-between items-center mt-2">
                          <span className="text-xs text-gray-500">
                            {formatDistanceToNow(new Date(item.notification.created_at), { addSuffix: true })}
                          </span>
                            ...
                            {item.notification.action_url && (
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  setIsOpen(false);
                                  window.location.href = item.notification.action_url;
                                }}
                              >
