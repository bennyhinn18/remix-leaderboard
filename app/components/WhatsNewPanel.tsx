...
import { X, AlertCircle, ArrowRight, ChevronDown, ChevronUp, Bell } from "lucide-react";
...
export default function WhatsNewPanel() {
  ...
  const updates = [
    ...
    },
    {
      ...
      description: "You can now view your points history as an interactive graph on your profile page.",
      link: null
    },
    {
      version: "v1.0.5", 
      ...
      description: "The 'Find Me' button now shows directional arrows to help you locate yourself on the leaderboard.",
      link: "/leaderboard"
    }
  ];
  ...
  useEffect(() => {
    ...
    const lastDismissedVersion = localStorage.getItem("whatsNewDismissedVersion");
          ...
          <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2">
            {updates.slice(0, 3).map((update) => (
              <div key={update.version} className="bg-white/5 rounded-lg p-3">
                ...
                {update.link && (
                  <Link to={update.link} className="inline-flex items-center text-xs font-medium text-blue-400 hover:text-blue-300">
                    Check it out
            ...
            {updates.length > 3 && (
              <div className="text-center mt-2">
                <button 
                  ...
                  onClick={() => {/* You could show more updates here */}}
                >
                  Show older updates
                </button>
              </div>
