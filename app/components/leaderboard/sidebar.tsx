...
import { Trophy, Book, Code, MessageCircle, Feather, Building, Home, Settings, User, Crown } from "lucide-react";
    ...
    <div className="hidden md:flex h-screen bg-gray-900 w-[200px] text-white flex-col border-r border-white/10 fixed left-0 top-0">
      <div className="p-4 flex items-center justify-center border-b border-white/10">
        <Link to="/" className="flex items-center justify-center">
          <img src={iconImage || "/placeholder.svg"} alt="Basher Logo" className="w-12 h-12" />
        </Link>
      </div>
          ...
          const content = (
            <motion.div
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer ${
                item.isActive ? "bg-blue-500 text-white" : "text-gray-300 hover:bg-white/10"
              }`}
